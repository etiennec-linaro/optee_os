...
/* SHRES_UNREGISTERED must be 0 to match shres_state default content */
...
static void set_etzpc_secure_configuration(void)
{
	...
	etzpc_configure_decprot(STM32MP1_ETZPC_STGENC_ID, TZPC_DECPROT_S_RW);
	etzpc_configure_decprot(STM32MP1_ETZPC_BKPSRAM_ID, TZPC_DECPROT_S_RW);
	etzpc_configure_decprot(STM32MP1_ETZPC_DDRCTRL_ID, TZPC_DECPROT_S_RW);
	etzpc_configure_decprot(STM32MP1_ETZPC_DDRPHYC_ID, TZPC_DECPROT_S_RW);
