    ...
    struct fwk_event *resp_event)
{
    ...
    const struct mod_psu_driver_response *params = (void *)event->params;
    struct mod_psu_response *resp_params = (void *)resp_event->params;
    struct mod_psu_response *hal_params = (void *)&hal_event.params;
