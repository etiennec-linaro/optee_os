...
cppflags-lib-y += $(if $(strip $(filter y,$$2)),-D$2=1,-D$1=0)
endef
...
$(eval $(call define-as-binary, BUILD_HAS_MOD_CLOCK, \
				CFG_SCMI_SERVER_CLOCK))
$(eval $(call define-as-binary,BUILD_HAS_MOD_POWER_DOMAIN, \
				CFG_SCMI_SERVER_POWER_DOMAIN))
$(eval $(call define-as-binary, BUILD_HAS_MOD_RESET_DOMAIN, \
				CFG_SCMI_SERVER_RESET_DOMAIN))
