...
static const struct string_id __maybe_unused string_cmd[] = {
	...
	PKCS11_ID(PKCS11_CMD_CK_SLOT_LIST),
	PKCS11_ID(PKCS11_CMD_CK_SLOT_INFO),
	PKCS11_ID(PKCS11_CMD_CK_TOKEN_INFO),
	PKCS11_ID(PKCS11_CMD_CK_MECHANISM_IDS),
	PKCS11_ID(PKCS11_CMD_CK_MECHANISM_INFO),
	PKCS11_ID(PKCS11_CMD_CK_INIT_TOKEN),
	PKCS11_ID(PKCS11_CMD_CK_INIT_PIN),
	PKCS11_ID(PKCS11_CMD_CK_SET_PIN),
	PKCS11_ID(PKCS11_CMD_CK_OPEN_RO_SESSION),
	PKCS11_ID(PKCS11_CMD_CK_OPEN_RW_SESSION),
	PKCS11_ID(PKCS11_CMD_CK_CLOSE_SESSION),
	PKCS11_ID(PKCS11_CMD_CK_SESSION_INFO),
	PKCS11_ID(PKCS11_CMD_CK_CLOSE_ALL_SESSIONS),
	...
	PKCS11_ID(PKCS11_CMD_GENERATE_SYMM_KEY),
...
static const struct string_id __maybe_unused string_rc[] = {
	...
	PKCS11_ID(SKS_NOT_FOUND),
	PKCS11_ID(SKS_NOT_IMPLEMENTED),
};
