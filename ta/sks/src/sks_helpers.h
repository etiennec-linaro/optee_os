...
#define SKS_OK				PKCS11_CKR_OK
#define SKS_ERROR			PKCS11_CKR_GENERAL_ERROR
#define SKS_MEMORY			PKCS11_CKR_DEVICE_MEMORY
#define SKS_BAD_PARAM			PKCS11_CKR_ARGUMENTS_BAD
